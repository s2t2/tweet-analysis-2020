...
class LocalStorageService:
    ...
    def __init__(self, local_dirpath=None):
        self.local_dirpath = local_dirpath or os.path.join(DATA_DIR, "collection_v2")
        ...
        print("TOPICS:", os.path.abspath(self.topics_csv_filepath))
        print("TWEETS:", os.path.abspath(self.tweets_csv_filepath))

    def fetch_topic_names(self):
        """Returns a list of topic strings"""
        topics_df = read_csv(self.topics_csv_filepath)
        return self.topics_df["topic"].tolist()
