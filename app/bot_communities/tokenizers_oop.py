...
class ImpeachmentStopwords(Stopwords):
...
class ImpeachmentTokenizer(ImpeachmentStopwords):
    """
...
class PorterStemTokenizer(ImpeachmentStopwords):
...
class CustomStemTokenizer(ImpeachmentStopwords):

    def __init__(self):
        super().__init__()
        self.stemmer = ImpeachmentStemmer()
        print("IMPEACHMENT STEMMER", type(self.stemmer))
...
class SpacyEntityTokenizer(SpacyLemmaTokenizer):
